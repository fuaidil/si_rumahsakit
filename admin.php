    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="?halaman=pasien">Data Pasien</a>
                </li>
                <li>
                    <a href="?halaman=dokter">Data Dokter</a>
                </li>
                <li>
                    <a href="?halaman=perawat">Data Perawat</a>
                </li>
                <li>
                    <a href="?halaman=obat">Data Obat</a>
                </li>
                <li>
                    <a href="?halaman=ruangan">Data Ruangan</a>
                </li>
            </ul>
